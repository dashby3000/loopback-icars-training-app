...
/*
 * Set the data connector based upon environment variable setting
 */
var ds = require('./util/dataSourceSelector');
...
loopback.AccessToken.attachTo(ds);
loopback.Role.attachTo(ds);
loopback.ACL.attachTo(ds);
